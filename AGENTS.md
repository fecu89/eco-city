...
**Sync to plugin cache**: After editing skill files, copy to your agent's plugin cache directory (e.g. `~/.Codex/plugins/cache/local-plugins/game-creator/1.3.0/` for Codex).
