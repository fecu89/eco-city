...
export function openCarbonGameOverModal({ hourlyCarbon = 0, onReset } = {}) {
  setModal(`
    ...
    <div class="demolition-warning">
      <strong>탄소 위기가 ${CARBON_CRISIS.GAME_OVER_HOURS}시간 지속되어 도시 운영이 중단됐습니다.</strong>
      <p>안전 기준은 시간당 ${CARBON_CRISIS.SAFE_HOURLY} 이하입니다. 마지막 배출량은 ${round1(hourlyCarbon)}이며, 기준 이하로 운영하면 위험 시간이 시간당 ${CARBON_CRISIS.RECOVERY_PER_SAFE_HOUR}시간씩 회복됩니다.</p>
    </div>
