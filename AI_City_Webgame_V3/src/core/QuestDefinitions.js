...
const RAW_QUESTS = [
  ...
  quest('power-on', '생산 기반을 함께 켜라', '공장과 화력발전을 인접 배치하고 공장을 흑자로 2시간 가동하세요.', 5, ['green'], 'hours', [
    '공장 1개와 화력발전 1개가 필요합니다.',
    '두 시설을 같은 건설 계획에 올린 뒤 한꺼번에 확정하면 운영비 손실을 피할 수 있습니다.',
    '두 시설은 육각형 한 칸 거리로 인접해야 합니다.',
    '공장 전력 공급률과 가동률을 50% 이상으로 유지해 실제 수입을 2시간 연속 발생시키세요.',
  ...
  quest('storage-hub', '저탄소 저장 허브', '저장 허브로 저탄소 전력을 3시간 연속 공급하고 8E를 누적하세요.', 8, null, 'energy', [
    '에너지저장 시설을 재생에너지와 소비 시설 사이에 배치하세요.',
    '저장 허브 경로로 저탄소 전력을 3시간 연속 공급하세요.',
    '같은 연속 운영 중 전달된 저탄소 전력을 누적 8E 달성하세요.',
    '공급이 끊기면 연속 시간과 누적 전력이 다시 시작됩니다.',
    '완료 후 배터리가 핵발전 예비력을 대신해 마지막 화력발전을 철거할 수 있습니다.',
  ]),
  ...
  quest('low-carbon-water', '저탄소 물순환 도시', '후반 성장을 적용하고 저탄소 70%, 낮은 물 사용과 흑자를 4시간 유지하세요.', 14, null, 'hours', [
    'Lv.3 시설을 하나 이상 운영하거나 통합 재생전력망 연구를 완료하세요.',
